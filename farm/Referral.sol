...
contract Referral is Ownable {
    ...
    constructor(address _fury, address _initializer) {
        fury = _fury;
        _transferOwnership(_initializer);
    }

    function pendingFury(address _user) external view returns (uint256) {
    ...
    function claim() external {
        ...
        IBEP20(fury).transfer(msg.sender, _rewardToTransfer);
